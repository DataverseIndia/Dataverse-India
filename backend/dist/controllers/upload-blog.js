...
exports.upload_blog = void 0;
const schema_1 = require("../config/schema");
const upload_blog = async (req, res) => {
    ...
    const isUploaded = await schema_1.db.insert(schema_1.blogs).values({ email: req.body.mail, main_heading: main_heading, sub_heading_1: sub_heading_1, sub_heading_2: sub_heading_2, sub_heading_3: sub_heading_3, sub_heading_4: sub_heading_4, sub_heading_5: sub_heading_5, sub_heading_6: sub_heading_6, sub_heading_7: sub_heading_7, sub_heading_8: sub_heading_8, main_paragraph: main_paragraph, para_1: para_1, para_2: para_2, para_3: para_3, para_4: para_4, para_5: para_5, para_6: para_6, para_7: para_7, para_8: para_8, image_url: image_url, published_at: published_at });
    if (isUploaded) {
...
exports.upload_blog = upload_blog;
//# sourceMappingURL=upload-blog.js.map